...
\define{\includeimgclip{filename}{top}{right}{bottom}{left}{width}{class}{align}}{<img class="\class" src="\filename" width="\width" align="\align" style="background:none; border:none; box-shadow:none; position:absolute; clip:rect(\top,\right,\bottom,\left)">}
...
\define{\includecovariance{shortname}}{\columns{\includesvgclass{../slides/diagrams/kern/\concat{\shortname}{_covariance.svg}}}{\includegif{../slides/diagrams/kern/\concat{\shortname}{_covariance}}{100%}{negate}}{45%}{45%}}
...
\define{\includeimgclip{filename}{top}{right}{bottom}{left}{width}{class}{align}}{<img class="\class" src="\filename" width="\width" align="\align" style="background:none; border:none; box-shadow:none; position:absolute; clip:rect(\top,\right,\bottom,\left)">}
\define{\includegif{filename}{width}{class}}{<img class="\class" src="\filename" width="\width" style="background:none; border:none; box-shadow:none;">}
\define{\includesvg{filename}{align}{class}{style}}{<div style="text-align:\align" class="\class"><object class="svgplot \class" align="\align" data="\filename" style="\style"></object></div>}
\define{\includesvgclass{filename}{class}{align}}{<object class="\class" align="\align" data="\filename"></object>}
\define{\includehtml{filename}{width}{height}}{<iframe src="\filename" width="\width" height="\height" allowtransparency="true" frameborder="0">
</iframe>}
...
\define{\includegif{filename}{width}{class}}{\div{\includeimg{\concat{\filename}{.gif}}{\width}{\class}{center}}{}{text-align:center}}
