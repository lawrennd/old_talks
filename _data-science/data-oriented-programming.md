...
abstract: >
  ...
  While languages for data manipulation exist (for example SQL), we view it as a low-level language. Higher level languages would place data at the center of modern digital systems design and provide an infrastructure in which monitoring of data quality and model decision making are automaticaly available.
  
  We provide the context for Data Oriented Programming, and give some insight into our initial ideas in this space.
author:
- family: Lawrence
  given: Neil D.
